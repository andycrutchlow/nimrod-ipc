...
public class TestPublisherAManyToOne implements InstanceEventReceiverInterface {
    static ZeroMQPubSubPublisher publisher;
    static TestPublisherAManyToOne instance = new TestPublisherAManyToOne();
    ...
    public static void main(String[] args) {
        ...
        publisher.setInstanceName("TestPublisherA");
